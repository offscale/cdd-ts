...
describe("SDK Integration Tests", () => {
	describe("PetService", () => {
		...
		it("should call updatePetWithForm successfully", async () => {
			try {
				const result = await service.updatePetWithForm(
					123,
					"string-value",
					"string-value",
					{
		...
		it("should call deletePet successfully", async () => {
			try {
				const result = await service.deletePet(123, "string-value", {
					headers: {
						api_key: "special-key",
						Authorization: "Bearer special-key",
					},
	...
	describe("UserService", () => {
		...
		it("should call getUserByName successfully", async () => {
			try {
				const result = await service.getUserByName("string-value", {
					headers: {
						api_key: "special-key",
						Authorization: "Bearer special-key",
					},
		...
		it("should call deleteUser successfully", async () => {
			try {
				const result = await service.deleteUser("string-value", {
					headers: {
						api_key: "special-key",
						Authorization: "Bearer special-key",
					},
		...
		it("should call loginUser successfully", async () => {
			try {
				const result = await service.loginUser("string-value", "string-value", {
					headers: {
						api_key: "special-key",
						Authorization: "Bearer special-key",
					},
