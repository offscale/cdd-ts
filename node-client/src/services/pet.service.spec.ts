...
describe('PetService', () => {
    ...
    describe('uploadFile', () => {
        it('should make a POST request to /pet/{petId}/uploadImage', async () => {
            ...
            const result = await service.uploadFile('123', { headers: { 'api_key': 'special-key', 'Authorization': 'Bearer special-key' } });
    ...
    describe('updatePetWithForm', () => {
        it('should make a POST request to /pet/{petId}', async () => {
            ...
            const result = await service.updatePetWithForm('123', { headers: { 'api_key': 'special-key', 'Authorization': 'Bearer special-key' } });
            expect(result).toBeDefined();
        });
    });
    ...
    describe('deletePet', () => {
        it('should make a DELETE request to /pet/{petId}', async () => {
            ...
            const result = await service.deletePet('123', { headers: { 'api_key': 'special-key', 'Authorization': 'Bearer special-key' } });
            expect(result).toBeDefined();
        });
    });
