import { XmlPropertyConfig } from "./xml-builder";
...
export class XmlParser {
    public static parse(xml: string, config?: XmlPropertyConfig): string | number | boolean | object | undefined | null {
    ...
    private static parseNode(node: Element, config: XmlPropertyConfig): string | number | boolean | object | undefined | null {
    ...
    private static parseArrayNode(node: ChildNode, config: XmlPropertyConfig): string | number | boolean | object | undefined | null {
    ...
    private static findChild(parent: Element, tagName: string): Element | undefined {
