import { ContentEncoder, ContentEncoderConfig } from "./content-encoder";
...
export class ParameterSerializer {
    ...
    private static encodeReservedInternal(value: string, allowPathDelims: boolean): string {
    ...
    public static serializePathParam(key: string, value: string | number | boolean | object | undefined | null, style: string = 'simple', explode: boolean = false, allowReserved: boolean = false, serialization?: 'json' | undefined, contentEncoderConfig?: ContentEncoderConfig): string {
    ...
    public static serializeQueryParam(config: SerializeQueryParamConfig, value: string | number | boolean | object | undefined | null): SerializedQueryParam[] {
    ...
    public static serializeHeaderParam(value: string | number | boolean | object | undefined | null, explode: boolean = false, serialization?: 'json' | undefined, contentType?: string | undefined, encoding?: Record<string, SerializeQueryParamConfig> | undefined, contentEncoderConfig?: ContentEncoderConfig): string {
    ...
    public static serializeCookieParam(key: string, value: string | number | boolean | object | undefined | null, style: string = 'form', explode: boolean = true, allowReserved: boolean = false, serialization?: 'json' | undefined, contentEncoderConfig?: ContentEncoderConfig): string {
    ...
    public static serializeRawQuerystring(value: string | number | boolean | object | undefined | null, serialization?: 'json' | undefined, contentType?: string | undefined, encodings?: Record<string, SerializeQueryParamConfig> | undefined, contentEncoderConfig?: ContentEncoderConfig): string {
    ...
    public static serializeUrlEncodedBody(body: string | number | boolean | object | undefined | null, encodings: Record<string, SerializeQueryParamConfig> = {}): SerializedQueryParam[] {
