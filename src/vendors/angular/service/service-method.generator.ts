...
export class ServiceMethodGenerator {
    ...
    private extractParameterExample(param: Parameter): OpenApiValue | undefined {
        ...
        if (
            ...
            const schema = param.schema as Record<string, string | number | boolean | object | undefined | null>;
    ...
    private buildOperationMetaTags(operation: PathInfo): string[] {
        ...
        const querystringParam = (operation.parameters ?? []).find(p => (p as { in?: string }).in === 'querystring');
    ...
    private getRawOperation(
        ...
        const direct = (pathItem as Record<string, string | number | boolean | object | undefined | null>)[methodKey];
        ...
        xmlParams.forEach(({ param, schema }) => {
            ...
            const xmlConfig = (
                this.analyzer as OpenApiValue as {
                    getXmlConfig: (a: OpenApiValue, b: number) => string | number | boolean | object | undefined | null;
                }
    ...
    private emitOverloads(
        ...
        const defaultResponseType =
            uniqueTypes.length > 1
                ? unionType
                : responseType === 'string | number | boolean | object | undefined | null'
                  ? 'Record<string, string | number | boolean | object | undefined | null>'
                  : responseType || 'Record<string, string | number | boolean | object | undefined | null>';
