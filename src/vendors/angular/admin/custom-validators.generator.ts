	...
	private addValidationMethods(validatorsClass: ClassDeclaration): void {
		const methods: OptionalKind<MethodDeclarationStructure>[] = [
				...
				statements: (writer) =>
					writer
						...
						.indent(() => {
							...
							writer.indent(() =>
								writer.writeLine("return { uniqueItems: true };"),
							);
			...
			},
			{
				...
				returnType: "ValidatorFn",
				docs: [
					"Validator ensuring objects/maps have at least the required number of properties.",
				],
				statements: (writer) =>
					writer
						.writeLine(
						...
						.indent(() => {
							...
							writer.indent(() =>
								writer.writeLine(
									"return min <= 0 ? null : { minProperties: { min, actual: 0 } };",
								),
							);
							...
							writer.indent(() =>
								writer.writeLine(
									"return { minProperties: { min, actual: count } };",
								),
							);
			...
			},
			{
				...
				returnType: "ValidatorFn",
				docs: [
					"Validator ensuring objects/maps do not exceed the maximum number of properties.",
				],
				statements: (writer) =>
					writer
						.writeLine(
						...
						.indent(() => {
							...
							writer.indent(() =>
								writer.writeLine(
									"return { maxProperties: { max, actual: count } };",
								),
							);
			...
			},
			{
				...
				returnType: "ValidatorFn",
				docs: [
					"Validator ensuring arrays contain items matching a schema (contains/minContains/maxContains).",
				],
				statements: (writer) =>
					writer
						.writeLine(
							"const isRecord = (value: Record<string, string | number | boolean | object | undefined | null> | string | number | boolean | null): value is Record<string, string | number | boolean | object | undefined | null> => {",
						)
						.indent(() => {
							writer.writeLine(
						...
						.writeLine("};")
						.writeLine(
							"const isNumber = (value: Record<string, string | number | boolean | object | undefined | null> | string | number | boolean | null): value is number => {",
						)
						.indent(() => {
							writer.writeLine(
						...
						.writeLine("};")
						.writeLine(
							"const isString = (value: Record<string, string | number | boolean | object | undefined | null> | string | number | boolean | null): value is string => typeof value === 'string';",
						)
						.writeLine(
							"const deepEqual = (left: Record<string, string | number | boolean | object | undefined | null> | string | number | boolean | null, right: Record<string, string | number | boolean | object | undefined | null> | string | number | boolean | null): boolean => {",
						)
						.indent(() => {
						...
						.writeLine("};")
						.writeLine(
							"const matchesType = (value: Record<string, string | number | boolean | object | undefined | null> | string | number | boolean | null, type: string): boolean => {",
						)
						.indent(() => {
							...
							writer.indent(() => {
								...
								writer.indent(() =>
									writer.writeLine("return Array.isArray(value);"),
								);

								writer.writeLine("case 'object':");

								writer.indent(() =>
									writer.writeLine("return isRecord(value);"),
								);

								writer.writeLine("case 'string':");

								writer.indent(() =>
									writer.writeLine("return typeof value === 'string';"),
								);

								writer.writeLine("case 'boolean':");

								writer.indent(() =>
									writer.writeLine("return typeof value === 'boolean';"),
								);
								...
								writer.indent(() =>
									writer.writeLine("return isNumber(value);"),
								);
						...
						.writeLine("};")
						.writeLine(
							"const matchesSchema = (value: Record<string, string | number | boolean | object | undefined | null> | string | number | boolean | null, schemaValue: Record<string, string | number | boolean | object | undefined | null> | string | number | boolean | null): boolean => {",
						)
						.indent(() => {
							...
							writer.writeLine(
								"const numericValue = isNumber(value) ? value : undefined;",
							);
							...
							writer.writeLine(
								"if (typeof schemaObj.exclusiveMinimum === 'number') {",
							);
							...
							writer.writeLine(
								"if (typeof schemaObj.exclusiveMaximum === 'number') {",
							);
						...
						.indent(() => {
							...
							writer.writeLine(
								"const minRequired = min !== undefined ? min : 1;",
							);

							writer.writeLine(
								"if (typeof minRequired === 'number' && matchCount < minRequired) {",
							);

							writer.indent(() =>
								writer.writeLine(
									"return { contains: { min: minRequired, actual: matchCount } };",
								),
							);
							...
							writer.writeLine(
								"if (typeof max === 'number' && matchCount > max) {",
							);

							writer.indent(() =>
								writer.writeLine(
									"return { contains: { max, actual: matchCount } };",
								),
							);
			...
			},
			{
				...
				returnType: "ValidatorFn",
				docs: [
					"Validator ensuring the value matches a constant (OAS 3.1 const keyword).",
				],
				statements: (writer) =>
					writer
						.writeLine(
			...
			},
			{
				...
				returnType: "ValidatorFn",
				docs: [
					"Inverse validator: Returns error if the inner validator passes (returns null).",
				],
				statements: (writer) =>
					writer
						.writeLine(
